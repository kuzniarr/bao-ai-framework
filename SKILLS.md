...
| `/validate-requirements` | ✅ ready | 3 · Requirements | Reviews requirements against structure, scope, clarity, API mapping. Returns issues only — does not rewrite. | Reviewing a requirements document |
