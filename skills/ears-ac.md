---
name: ears-ac
description: "Write Acceptance Criteria in EARS for an approved user story, in the project house style: numbered criteria with a short group title, a Data Dictionary for forms, screen references, and the story's open questions beneath it. Minimal by default, behaviour only, no UI description. Use after stories are decomposed and approved, before refinement."
---
...
2. Product Context — /mnt/project/Product_Context_actual.md. Authoritative for behaviour, roles, and user states. Where the Product Context and the WBS raw AC differ, the Product Context is the resolved state — raise the difference as an open question.  
